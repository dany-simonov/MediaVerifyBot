      ...
      <div className="container">
        ...
        <section className="mb-16">
          ...
          <p className="text-mv-text-secondary leading-relaxed">
            Проект доступен как Telegram-бот (@MediaVerifyBot), веб-платформа и REST API для интеграции. Наша архитектура построена на React + Appwrite Cloud с асинхронной обработкой, что обеспечивает обработку запросов за 1-3 секунды.
          </p>
        </section>
