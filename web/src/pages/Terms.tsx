        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-mv-text-secondary leading-relaxed">
              Используя сервис «Источник» (веб-сайт, Telegram-бот, API), вы соглашаетесь с настоящими Условиями использования. Если вы не согласны с этими условиями, пожалуйста, прекратите использование сервиса.
            </p>
          </section>
